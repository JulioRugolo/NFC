...
function App() {
  ...
  useEffect(() => {
    ...
    setInfo({
      ...
      telefoneEmpresa: decodeParam(params.get('telefoneEmpresa') || ''),
  ...
  const hasInfo = info.nomeCrianca || info.nomePai || info.nomeMae || 
                  ...
                  info.nomeEmpresa || info.telefoneEmpresa || info.enderecoEmpresa
                  ...
                  <div className="contact-section">
                    <div className="contact-info">
                      ...
                      <div className="phone-number" onClick={() => {
                        navigator.clipboard.writeText(info.telefoneEmpresa.replace(/\D/g, '')).then(() => {
                          alert('Número copiado!')
                        })
                      }}>
                        {formatPhone(info.telefoneEmpresa)}
                      </div>
                    </div>
                    <div className="contact-buttons">
                      <button 
                        className="btn-icon btn-phone-icon" 
                        onClick={() => handleCall(info.telefoneEmpresa)}
                        title={`Ligar ${formatPhone(info.telefoneEmpresa)}`}
                      >
                      ...
                      <button 
                        ...
                        onClick={() => handleWhatsApp(info.telefoneEmpresa, info.nomeEmpresa)}
                        title={`WhatsApp ${formatPhone(info.telefoneEmpresa)}`}
                      >
